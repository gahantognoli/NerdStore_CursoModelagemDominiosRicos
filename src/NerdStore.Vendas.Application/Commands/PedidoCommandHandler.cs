...

    {
        ...
        public async Task<bool> Handle(AdicionarItemPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                {
                    _pedidoRepository.AtualizarItem(pedido.PedidoItens.FirstOrDefault(pedido => pedido.ProdutoId == pedido.ProdutoId));
                }
                else
                {
            ...
            pedido.AdicionarEvento(new ItemPedidoAdicionadoEvent(pedido.ClienteId, pedido.Id, message.ProdutoId, message.Nome, message.ValorUnitario, message.Quantidade));
